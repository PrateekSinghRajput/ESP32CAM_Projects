...
String recognize_face_matched_name[7] = { "User0", "User1", "User2", "User3", "User4", "User5", "User6" };
  ...
  if (align_face(net_boxes, image_matrix, aligned_face) == ESP_OK) {
    if (is_enrolling == 1) {
      ...
      if (matched_id >= 0) {
        ...
        Serial.print('9');
        rgb_print(image_matrix, FACE_COLOR_RED, "Unknown User");
        matched_id = -1;
        FaceNoMatched();
      }
    }
