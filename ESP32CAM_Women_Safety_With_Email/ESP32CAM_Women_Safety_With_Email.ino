...
#define emailSenderAccount "vaibhav.thigale.15@gmail.com"  //To use send Email for Gmail to port 465 (SSL), less secure app option should be enabled. https://myaccount.google.com/lesssecureapps?pli=1
#define emailSenderPassword "hari@8856889101"


#define emailRecipient "patiks310@gmail.com"
#define emailRecipient2 "vaibav.thigale.15@gmail.com"
#define emailRecipient3 "shivjadhav053@gmail.com"
#define emailRecipient4 "patl.pushpa321@gmail.com"
...
void setup() {
  ...
  if (!EEPROM.begin(EEPROM_SIZE)) {
    ...
    while (1)
      ;  //wait here as something is not right
  }
...
void sendCallback(SendStatus msg) {
  ...
  if (msg.success()) {
    Serial.println("----------------");
    Serial.println("ATD+918856889101;");
    delay(400);
    Serial.println("AT+CMGF=1");
    delay(1000);
    Serial.println("AT+CMGS=\"+918856889101\"\r");
